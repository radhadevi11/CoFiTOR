...
public class BPR2RSVD
{
	...
	// number of target training triples of (user,item,rating)
	public static int num_train_target; 
	
	// number of test triples of (user,item,rating)
	...
	// === candidatelist from other models: user -> items
	...
	public static void readData(String fnTrainData, String fnTestData) throws Exception
    {
    	...
    	// ======================================================
		// === Read candidatelist: user -> items
    	BufferedReader brUserTopKItem = new BufferedReader(new FileReader(fnInputCandidateItems));
    	line = null;
    ...
    public static void train()
	{
		for (int iter = 0; iter < num_iterations; iter++) {
			for (int iter_rand = 0; iter_rand < num_train_target; iter_rand++) {
				// ======================================================
				// --- random sampling (userID,itemID,rating)
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	public static void testRanking(HashMap<Integer, HashSet<Integer>> TestDataforRank) throws IOException
    {
    	...
    	for(int u=1; u<=n; u++)
		{
			...
			// --- sort
			listY = HeapSort.heapSort(listY, topK); // Lei LI's heapsort
			...
			// --- number of warm-start users in test data
			UserNum_TestData++; 
